...
uint64 SqSet[64], SqClear[64], NonDiag[64], NonOrtho[64];
uint64 Ortho[64], Diag[64], OrthoDiag[64];
...
uint64 Left2[64], Right2[64], Left1[64], Right1[64], Adjacent[64], LongDiag[64];
